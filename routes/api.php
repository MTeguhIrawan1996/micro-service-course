...
Route::delete('mentors/{id}', "MentorController@delete");
...
Route::delete('chapters/{id}', "ChapterController@delete");
...
Route::delete('image-courses/{id}', "ImageCourseController@delete");
